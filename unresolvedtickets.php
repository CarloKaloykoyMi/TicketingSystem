    ...
    <div class="main p-3">
        <div class="container-fluid">
            ...
            <table id="example" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th scope="text-center">Ticket ID</th>
                        <th scope="text-center">Requestor</th>
                        <th scope="text-center">To Department</th>
                        <th scope="text-center">Subject</th>
                        <th scope="text-center">Status</th>
                        <th scope="text-center">Date Created</th>
                        <th class="text-center">Unresolved by</th>
                        <th class="text-center">Unresolved date</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    if (mysqli_num_rows($ticket) > 0) {
                        foreach ($ticket as $item) {
                            ...
                            $unresolved_by = "SELECT t.*, u.firstname, u.lastname 
                                FROM ticket t 
                                INNER JOIN user u ON t.updated_by = u.user_id 
                                WHERE t.ticket_id = " . $item['ticket_id'];
                            $unresolved_result = mysqli_query($con, $unresolved_by);
                            $unresolved_row = mysqli_fetch_assoc($unresolved_result);
                    ?>
                            <tr>
                                ...
                                <td><?= (!empty($unresolved_row['firstname']) && !empty($unresolved_row['lastname'])) ? $unresolved_row['firstname'] . ' ' . $unresolved_row['lastname'] : ''; ?></td>
