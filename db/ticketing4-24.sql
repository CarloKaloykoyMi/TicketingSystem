...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 24, 2024 at 07:30 AM
...
(2, 1006, 42, 37, 5, NULL, 'try ulit 2nd time', NULL),
...
--
ALTER TABLE `audit_trail`
  MODIFY `at_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=333;
...
--
ALTER TABLE `ticket`
  MODIFY `ticket_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1024;
